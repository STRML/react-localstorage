...
/**
* Filters state to only save keys defined in localStorageKeys in props
*/
function getSyncState(component, state) {
  if (!component.props.localStorageKeys) return state;
  var result = {};
  component.props.localStorageKeys.forEach(function(sk) {
    for (var key in state) {
      if (state.hasOwnProperty(key) && sk === key) {
